...
const ResumeSection = () => {
  return (
    <section className="py-20 relative overflow-hidden" id="resume">
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-purple-500/10 to-violet-500/10 rounded-full filter blur-3xl"></div>
      </div>
            ...
            <CardContent className="p-8">
              <div className="grid lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="relative">
                  <div className="bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl p-8 border border-purple-400/20 hover:border-purple-400/40 transition-colors">
                  ...
                  {/* Decorative glow */}
                  <div className="absolute -inset-4 bg-gradient-to-r from-purple-500/20 to-violet-500/20 rounded-xl filter blur-xl -z-10"></div>
                </div>
                ...
                <div className="text-center lg:text-left">
                  ...
                  <div className="space-y-4">
                    <Button
                      className="w-full lg:w-auto bg-gradient-to-r from-purple-500 to-violet-500 hover:from-purple-400 hover:to-violet-400 text-white px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl btn-pulse"
                      asChild
                    >
                    ...
                    <Button
                      variant="outline"
                      className="w-full lg:w-auto border-purple-400/50 text-purple-400 hover:bg-purple-400/10 hover:border-purple-400 px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300"
                      asChild
                    >
                  ...
                  <div className="mt-8 p-4 bg-gradient-to-r from-purple-500/10 to-violet-500/10 rounded-lg border border-purple-400/20">
                    <p className="text-sm text-slate-400">
                      📄 <strong className="text-purple-400">Updated:</strong> December 2024 | 
                      📊 <strong className="text-purple-400">Format:</strong> PDF | 
                      📝 <strong className="text-purple-400">Size:</strong> 2 pages
                    </p>
                  </div>
                </div>
              </div>
